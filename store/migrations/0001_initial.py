    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custumer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.custumer')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('F', 'Pending'), ('F', 'Complete'), ('F', 'Failed')], default='F', max_length=1)),
                ('custumer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store.custumer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='featured_in_collections', to='store.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
